...
# چون ربات بازی گاهی زیر یوزرنیم‌های مختلف دیده شده (MeowieeeQBot،
# MeowieQBot و MeowieeQBot)، همه‌شون رو قبول می‌کنیم تا پیام‌ها بسته به
# اینکه از کدوم یوزرنیم بیان، نادیده گرفته نشن.
MEOWIE_BOT_USERNAMES = {"meowieeeqbot", "meowieqbot", "meowieeqbot"}
